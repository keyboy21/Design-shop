...
import Phone from '../../public/photoIP.png'
import Image from 'next/image'
import Cart from '../../public/Property 1=Defaultbasket.png'
      ...
      <div className="min-w-[1097px] px-7 pt-5 pb-7 mt-5 ml-5 mb-4 bg-Content rounded-md">
        <div className="mb-5">
          <div className="not-italic text-[12px] mb-[30px] space-x-1">
            ...
            <Link href="/">
              <span className="text-Notification font-medium  leading-[14px]">Оформить заказ</span>
            </Link>
            <i className="fa-solid fa-angle-right text-Notification"></i>
